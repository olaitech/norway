      ...
      <div className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {links.map((link) => (
          <Link
            key={link.href}
            href={link.href}
            className="internal-card-link group block h-full rounded-[1.15rem] border border-[#8fafa8]/12 bg-[linear-gradient(165deg,rgba(23,35,38,0.82),rgba(8,17,22,0.94))] p-6 shadow-[0_20px_64px_rgba(0,0,0,0.18)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#c6a15b]/55 sm:p-7"
          >
            {link.label ? (
            ...
            <div className="mt-4 flex items-start justify-between gap-4">
              <h3 data-card-title className="font-serif text-[1.55rem] leading-[1.02] tracking-[-0.035em] text-[#f4efe2] sm:text-[1.7rem]">
                {link.title}
              </h3>
              <ArrowUpRight data-card-cue className="mt-1 h-4 w-4 shrink-0 text-[#c6a15b]/72" />
            </div>
