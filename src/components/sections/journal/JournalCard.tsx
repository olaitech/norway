...
export function JournalCard({
  ...
  if (featured) {
    return (
      <article className="group grid overflow-hidden rounded-[1.35rem] border border-white/10 bg-white/[0.025] shadow-[0_32px_100px_rgba(0,0,0,0.36)] lg:grid-cols-[1.1fr_0.9fr]">
  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-[1.2rem] border border-white/9 bg-white/[0.02] transition-[border-color,background-color] duration-500 hover:border-white/16 hover:bg-white/[0.03]">
      <div
