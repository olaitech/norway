...
export function JournalCard({
        ...
        <article className="surface-fjord grid overflow-hidden rounded-[1.35rem] lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="flex flex-col justify-between p-7 sm:p-10 lg:p-12">
            <div>
              ...
              <h2
                data-card-title
                className="mt-9 font-serif text-[clamp(2.5rem,4.6vw,4.15rem)] font-normal leading-[0.98] tracking-[-0.052em] text-[#f4efe2]"
              >
                {entry.title}
              </h2>
  ...
  return (
    <Link
      href={`/journal/${entry.slug}`}
      className="internal-card-link group block h-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d8c9a7]/55"
    >
      <article className="surface-fjord flex h-full flex-col overflow-hidden rounded-[1.2rem]">
        <div
        ...
        <div className="flex grow flex-col p-6 sm:p-7">
          ...
          <h3
            data-card-title
            className="mt-7 font-serif text-[clamp(1.75rem,3vw,2.15rem)] font-normal leading-[1.08] tracking-[-0.038em] text-[#f4efe2]"
          >
            {entry.title}
          </h3>
          ...
          <div className="mt-8 flex items-center justify-between border-t border-white/8 pt-5 text-[0.59rem] font-medium uppercase tracking-[0.25em] text-[#f4efe2]/46">
            ...
            <ArrowUpRight
              data-card-cue
              className="h-4 w-4 text-[#d8c9a7]/64"
            />
          </div>
        </div>
      </article>
