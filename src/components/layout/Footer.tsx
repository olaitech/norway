...
function FooterColumn({ title, links }: FooterColumnProps) {
  return (
    <nav aria-label={title}>
      <h2 className="text-[0.68rem] font-medium uppercase tracking-[0.28em] text-[#c6a15b]">
        {title}
      </h2>
...
export function Footer() {
  ...
  return (
    <footer
      className="relative overflow-hidden border-t border-white/[0.08] bg-[linear-gradient(180deg,var(--arctic-slate)_0%,var(--polar-night)_76%)] text-[#f4efe2]"
      aria-labelledby="site-footer-title"
    >
      <div className="pointer-events-none absolute inset-x-0 top-0 h-28 bg-[linear-gradient(180deg,rgba(198,161,91,0.06),rgba(5,8,10,0))]" />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_14%_12%,rgba(198,161,91,0.08),transparent_30%),radial-gradient(circle_at_82%_18%,rgba(143,175,168,0.06),transparent_34%)]" />
      <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[#c6a15b]/35 to-transparent" />
      ...
      <div className="relative mx-auto max-w-7xl px-5 pt-12 pb-14 sm:px-8 sm:pt-14 sm:pb-16 md:px-12 lg:pt-16 lg:pb-20">
        ...
        <div className="mt-14 flex flex-col gap-5 border-t border-white/[0.08] pt-7 text-xs font-light text-[#a8a095] sm:mt-16 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link
            href="#top"
            className="inline-flex w-fit items-center rounded-full border border-white/[0.1] px-4 py-2 text-[0.62rem] font-medium uppercase tracking-[0.24em] text-[#f4efe2]/78 transition-colors duration-300 hover:border-[#c6a15b]/45 hover:text-[#f4efe2] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#c6a15b]/50"
          >
            Back to top
          </Link>
        </div>
